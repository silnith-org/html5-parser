 ...
 * @see <a href="http://www.w3.org/TR/html5/syntax.html#tree-construction">8.2.5 Tree construction</a>
 */
public class Parser {
	...
	public enum Mode {
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#the-initial-insertion-mode">8.2.5.4.1 The "initial" insertion mode</a>
		 */
		INITIAL,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#the-before-html-insertion-mode">8.2.5.4.2 The "before html" insertion mode</a>
		 */
		BEFORE_HTML,
		/**
		...
		BEFORE_HEAD,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#parsing-main-inhead">8.2.5.4.4 The "in head" insertion mode</a>
		 */
		IN_HEAD,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#parsing-main-inheadnoscript">8.2.5.4.5 The "in head noscript" insertion mode</a>
		 */
		IN_HEAD_NOSCRIPT,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#the-after-head-insertion-mode">8.2.5.4.6 The "after head" insertion mode</a>
		 */
		AFTER_HEAD,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#parsing-main-inbody">8.2.5.4.7 The "in body" insertion mode</a>
		 */
		IN_BODY,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#parsing-main-incdata">8.2.5.4.8 The "text" insertion mode</a>
		 */
		TEXT,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#parsing-main-intable">8.2.5.4.9 The "in table" insertion mode</a>
		 */
		IN_TABLE,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#parsing-main-intabletext">8.2.5.4.10 The "in table text" insertion mode</a>
		 */
		IN_TABLE_TEXT,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#parsing-main-incaption">8.2.5.4.11 The "in caption" insertion mode</a>
		 */
		IN_CAPTION,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#parsing-main-incolgroup">8.2.5.4.12 The "in column group" insertion mode</a>
		 */
		IN_COLUMN_GROUP,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#parsing-main-intbody">8.2.5.4.13 The "in table body" insertion mode</a>
		 */
		IN_TABLE_BODY,
		/**
		...
		IN_ROW,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#parsing-main-intd">8.2.5.4.15 The "in cell" insertion mode</a>
		 */
		IN_CELL,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#parsing-main-inselect">8.2.5.4.16 The "in select" insertion mode</a>
		 */
		IN_SELECT,
		/**
		...
		IN_SELECT_IN_TABLE,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#parsing-main-intemplate">8.2.5.4.18 The "in template" insertion mode</a>
		 */
		IN_TEMPLATE,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#parsing-main-afterbody">8.2.5.4.19 The "after body" insertion mode</a>
		 */
		AFTER_BODY,
		/**
		...
		IN_FRAMESET,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#parsing-main-afterframeset">8.2.5.4.21 The "after frameset" insertion mode</a>
		 */
		AFTER_FRAMESET,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#the-after-after-body-insertion-mode">8.2.5.4.22 The "after after body" insertion mode</a>
		 */
		AFTER_AFTER_BODY,
		/**
		 * @see <a href="http://www.w3.org/TR/html5/syntax.html#the-after-after-frameset-insertion-mode">8.2.5.4.23 The "after after frameset" insertion mode</a>
		 */
	 ...
	 * construct a document using the given DOM implementation.  The DOM implementation
	 * must support feature "Core 2.0" or greater.
	 * 
	...
	/**
	 * Returns an {@link Iterable} over the stack of open elements.
	 * The direction of iteration is not guaranteed.
	 * 
	...
	public void pushOntoListOfActiveFormattingElements(final StartTagToken startTagToken, final Element element) {
		...
		int count = 0;
		final ListIterator<FormattingElement> iter = listOfActiveFormattingElements.listIterator(listOfActiveFormattingElements.size());
	 ...
	 * @see <a href="http://www.w3.org/TR/html5/syntax.html#mathml-text-integration-point">MathML text integration point</a>
	 */
	 ...
	 * @see <a href="http://www.w3.org/TR/html5/syntax.html#html-integration-point">HTML integration point</a>
	 */
	...
	/**
	 * Dispatch the next token to the current mode.
	 * This is prototype code and not used.
	 * 
	 * @param token the token to dispatch
	 * @see <a href="http://www.w3.org/TR/html5/syntax.html#tree-construction-dispatcher">tree construction dispatcher</a>
	 */
