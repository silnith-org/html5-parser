...
/**
 * Implements <a href="http://www.w3.org/TR/html5/syntax.html#rcdata-end-tag-name-state">8.2.4.13 RCDATA end tag name state</a>.
 * 
 * <p>This state assumes that there is a pending token in the tokenizer, and that
 ...
 * @see <a href="http://www.w3.org/TR/html5/syntax.html#rcdata-end-tag-name-state">8.2.4.13 RCDATA end tag name state</a>
