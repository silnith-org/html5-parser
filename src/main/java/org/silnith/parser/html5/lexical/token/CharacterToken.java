...
public class CharacterToken extends Token {
	...
	/**
	 * Converts an array of characters into a list of character tokens.  This
	 * is a literal conversion, no additional processing is done on the array.
	 * 
	 * @param characters the array of characters to convert
	 * @return a list of tokens representing the characters in the array, in order
	 */
	 ...
	 * @return a list of tokens representing the characters in the string, in order
	 */
	 ...
	 * is a literal conversion, no additional processing is done on the sequence.
	 * 
	 * @param charSequence the sequence of characters to convert
	 * @return a list of tokens representing the characters in the sequence, in order
	 */
