...
/**
 * @see <a
 *      href="http://www.w3.org/TR/html5/syntax.html#markup-declaration-open-state">8.2.4.45
...
public class MarkupDeclarationOpenState extends TokenizerState {
    ...
    public List<Token> getNextTokens() throws IOException {
        ...
        if (numRead == 7 && buf[0] == LEFT_SQUARE_BRACKET && buf[1] == 'C'
                && buf[2] == 'D' && buf[3] == 'A' && buf[4] == 'T'
                && buf[5] == 'A' && buf[6] == LEFT_SQUARE_BRACKET) {
            // TODO:
        ...
        if (isAllowParseErrors()) {
            ...
            throw new ParseErrorException("Unknown markup declaration: "
                    + String.valueOf(buf));
        }
    }
