...
/**
 * @see <a
 *      href="http://www.w3.org/TR/html5/syntax.html#doctype-public-identifier-%28single-quoted%29-state">8.2.4.59
 *      DOCTYPE public identifier (single-quoted) state</a>
    ...
    public List<Token> getNextTokens() throws IOException {
        ...
        case NULL: {
            if (isAllowParseErrors()) {
                ...
                throw new ParseErrorException(
                        "Null character in DOCTYPE public identifier (single-quoted).");
            }
        } // break;
        case GREATER_THAN_SIGN: {
            if (isAllowParseErrors()) {
                ...
                throw new ParseErrorException(
                        "Unexpected '>' in DOCTYPE public identifier (single-quoted).");
            }
        } // break;
        case EOF: {
            if (isAllowParseErrors()) {
                ...
                throw new ParseErrorException(
                        "Unexpected end-of-file in DOCTYPE public identifier (single-quoted).");
            }
        } // break;
        default: {
