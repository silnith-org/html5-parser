...
/**
 * @see <a href="http://www.w3.org/TR/html5/syntax.html#script-data-double-escape-end-state">8.2.4.33 Script data double escape end state</a>
 * @author <a href="mailto:silnith@gmail.com">Kent Rosenkoetter</a>
 */
public class ScriptDataDoubleEscapeEndState extends TokenizerState {

	public ScriptDataDoubleEscapeEndState(final Tokenizer tokenizer) {
		super(tokenizer);
	}
