...
/**
 * Applies the rawtext end tag name state logic.
 * <p>
 ...
 *   <dt>Anything else
 *   <dd>Switch to the RAWTEXT state. Emit a U+003C LESS-THAN SIGN character token, a U+002F SOLIDUS character token, and a character token for each of the characters in the temporary buffer (in the order they were added to the buffer). Reconsume the current input character.
 * </dl>
 * 
 * @see org.silnith.parser.html5.lexical.Tokenizer.State#RAWTEXT_END_TAG_NAME
 * @see <a href="https://www.w3.org/TR/2014/REC-html5-20141028/syntax.html#rawtext-end-tag-name-state">8.2.4.16 RAWTEXT end tag name state</a>
 * @author <a href="mailto:silnith@gmail.com">Kent Rosenkoetter</a>
 */
public class RAWTEXTEndTagNameState extends TokenizerState {
    
    public RAWTEXTEndTagNameState(final Tokenizer tokenizer) {
        super(tokenizer);
    }
