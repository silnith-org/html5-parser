 ...
 * <a href="http://www.w3.org/TR/html5/syntax.html#tokenization">8.2.4 Tokenization</a>.
 * 
 * @author <a href="mailto:silnith@gmail.com">Kent Rosenkoetter</a>
 * @see <a href="http://www.w3.org/TR/html5/syntax.html#tokenization">8.2.4 Tokenization</a>
 */
public class Tokenizer {
	...
	public void acknowledgeSelfClosingFlag() {
		if ( !emittedSelfClosingStartTag && !isAllowParseErrors()) {
			throw new ParseErrorException("Acknowledged a self-closing tag when the last tag to be emitted did not have the self-closing flag set.");
		}
		emittedSelfClosingStartTag = false;
	}
	 ...
	 * @see <a href="http://www.w3.org/TR/html5/syntax.html#appropriate-end-tag-token">appropriate end tag token</a>
	 */
	public boolean isAppropriateEndTagToken(final TagToken tagToken) {
		...
		if (tagToken.getType() != Token.Type.END_TAG) {
			throw new IllegalStateException("The pending token should be an end tag token, instead it is: " + tagToken.getType());
		}
