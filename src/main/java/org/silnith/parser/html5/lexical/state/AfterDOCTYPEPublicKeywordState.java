...
/**
 * @see <a
 *      href="http://www.w3.org/TR/html5/syntax.html#after-doctype-public-keyword-state">8.2.4.56
    ...
    public List<Token> getNextTokens() throws IOException {
        ...
        case QUOTATION_MARK: {
            if (isAllowParseErrors()) {
                ...
                throw new ParseErrorException(
                        "Unexpected quotation mark after DOCTYPE public keyword.");
            }
        } // break;
        case APOSTROPHE: {
            if (isAllowParseErrors()) {
                ...
                throw new ParseErrorException(
                        "Unexpected apostrophe after DOCTYPE public keyword.");
            }
        } // break;
        case GREATER_THAN_SIGN: {
            if (isAllowParseErrors()) {
                ...
                throw new ParseErrorException(
                        "Unexpected '>' after DOCTYPE public keyword.");
            }
        } // break;
        case EOF: {
            if (isAllowParseErrors()) {
                ...
                throw new ParseErrorException(
                        "Unexpected end-of-file after DOCTYPE public keyword.");
            }
        } // break;
        default: {
            if (isAllowParseErrors()) {
