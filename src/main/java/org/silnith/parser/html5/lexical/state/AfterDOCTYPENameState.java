...
/**
 * @see <a href="http://www.w3.org/TR/html5/syntax.html#after-doctype-name-state">8.2.4.55 After DOCTYPE name state</a>
	...
	public List<Token> getNextTokens() throws IOException {
		...
		default: {
			...
			if (isAllowParseErrors()) {
				...
				throw new ParseErrorException("Unknown keyword after DOCTYPE name: " + String.valueOf(buf, 0, numRead + 1));
			}
		} // break;
		}
	}
